...
TBPN Transcripts GitHub repository. 
"""
import os
import zipfile
import requests
...
def unzip_file(zip_path):
    ...
    extracted_folder = os.path.join(cwd, "TBPN-Transcripts-main")
    if os.path.exists(extracted_folder):
        new_folder_name = "TBPN-Transcripts"
...
if __name__ == "__main__":
    ...
    url = "https://github.com/willtheorangeguy/TBPN-Transcripts/archive/refs/heads/main.zip"
    output_zip = "tbpn_transcripts.zip"
