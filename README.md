...
<!-- Copy -->
<h4 align="center">Transcripts and summaries generated from TBPN episodes through OpenAI Whisper, Llama 3.1, and LanguageTool.</h4>

<!-- Badges -->
<div align="center">
  <!-- Issues -->
  <img alt="GitHub Issues" src="https://img.shields.io/github/issues/willtheorangeguy/TBPN-Transcripts">
  <!-- Pull Requests -->
  <img alt="GitHub Pull Requests" src="https://img.shields.io/github/issues-pr/willtheorangeguy/TBPN-Transcripts">
  <!-- Discord -->
  <img alt="Discord Server ID" src="https://img.shields.io/discord/1382526731528962088">
  <!-- Language Count -->
  <img alt="GitHub Languages" src="https://img.shields.io/github/languages/count/willtheorangeguy/TBPN-Transcripts">
</div>
...
- Pull all TBPN episodes, and convert them to audio.
...
**To clone and run your own copy of this website**, you'll need [Git](https://git-scm.com/downloads), [Ollama](https://ollama.com/) and a bunch of Python libraries installed on your computer. If you would rather not use Git, you can just download the code from GitHub [above](https://github.com/willtheorangeguy/TBPN-Transcripts/archive/refs/heads/main.zip). From your command line:

```bash
# Clone this repository
$ git clone https://github.com/willtheorangeguy/TBPN-Transcripts.git
...
If support is required, please open a **[GitHub Discussion](https://github.com/willtheorangeguy/TBPN-Transcripts/discussions/new)** or join our **[Discord](https://discord.gg/mgbda4fesN)**.

## Contributing

Please contribute using [GitHub Flow](https://guides.github.com/introduction/flow). Create a branch, add commits, and [open a pull request](https://github.com/willtheorangeguy/TBPN-Transcripts/compare).
...
<table>
  <tr>
    ...
    <th align="center"><img src="https://is1-ssl.mzstatic.com/image/thumb/Podcasts221/v4/41/6b/2f/416b2f9c-0b5a-f339-00c2-e9197b843563/mza_10413656104364780664.jpg/300x300bb.webp" width="150" height="150" alt="TBPN"/></th>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="center"><a href="https://www.tbpn.com/">Web</a></td>
  </tr>
</table>
...
The code in this repository is licensed under the [MIT License](https://mit-license.org/) - see the [`LICENSE`](LICENSE.md) file for details. The transcription of TBPN episodes contains spoken words which are copyright and the individual perspective of their respective speaker. This repository is in no way affiliated with OpenAI, YouTube, Google, or TBPN.
