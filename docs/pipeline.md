...
|---|---|---|---|
| 1 | `1_download.py` | This script uses yt-dlp to download audio, by year, from the Diet TBPN videos on YouTube. | — |
...
| 3 | `3_transcriber.py` | This script transcribes audio files from the Diet TBPN episodes using OpenAI's Whisper model. | `transcribed.log` |
